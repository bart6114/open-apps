...
Open Apps is a directory of real open-source applications you can run,
...
the license is clear. Open Apps turns that flat list into a structured
...
without owning the Open Apps product. Anyone can suggest an app, fix
