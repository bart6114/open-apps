...
reported to the project maintainers responsible for enforcement at the
issue tracker (private issue if you prefer not to disclose publicly). All
...
determining the consequences of any action they deem in violation of this
Code of Conduct:
...
**Consequence**: A temporary ban from any sort of public interaction with
...
**Consequence**: A permanent ban from any sort of public interaction with
the community.
...
[Mozilla's code of conduct enforcement ladder][mozilla-co].
